...
insert  into `comment`(`id`,`question_id`,`author_id`,`content`,`create_time`) values (1001,1001,NULL,'2',NULL);
...
insert  into `connect`(`conn_id`,`sid`,`cid`) values (1,20140101,1001),(2,20140109,1002),(3,20140110,1002),(4,20140111,1002),(5,20140112,1002),(6,20140113,1002),(7,20140109,1001),(8,20140115,1001),(9,20140115,1002);
...
insert  into `course`(`cid`,`cname`,`introduce`,`tno`) values (1001,'语文','这是语文课。',NULL),(1002,'aaa',NULL,NULL);
...
insert  into `question`(`id`,`title`,`content`,`create_time`,`author_id`) values (1001,'这题怎么做？','1+1=？',NULL,NULL);
