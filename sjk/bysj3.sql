...
insert  into `classname`(`id`,`name`,`tno`) values (1001,'计算机科学与技术143班',20080101),(1002,'计算机科学与技术144班',NULL);
...
insert  into `comment`(`id`,`question_id`,`author_id`,`content`,`create_time`,`tno`,`author_name`) values (1001,1001,NULL,'2',NULL,NULL,NULL),(1002,1001,NULL,'3',NULL,NULL,NULL),(1003,NULL,NULL,'woshi',NULL,NULL,NULL),(1004,NULL,NULL,'nihao',NULL,1001,NULL);
...
insert  into `course`(`cid`,`cname`,`introduce`,`tno`) values (1001,'语文','这是语文课。',20080101),(1002,'aaa',NULL,20080101),(1003,'数学','这是数学课。',20080101),(1004,'英语','这是英语课。',20080101),(1005,'bbb',NULL,20080101);
...
insert  into `question`(`id`,`title`,`content`,`create_time`,`author_id`,`tno`,`author_name`) values (1001,'这题怎么做？','1+1=？',NULL,NULL,NULL,NULL);
...
insert  into `student`(`sid`,`sname`,`password`,`sex`,`classname`,`telephone`,`email`,`clno`) values (20140101,'abcd','123',NULL,NULL,NULL,NULL,1001),(20140109,'周6','123','男',NULL,NULL,NULL,1001),(20140110,'周7','123',NULL,NULL,NULL,NULL,1001),(20140111,'周8','123',NULL,NULL,NULL,NULL,1001),(20140112,'周9','123',NULL,NULL,NULL,NULL,NULL),(20140113,'周10','123',NULL,NULL,NULL,NULL,NULL),(20140115,'周11','123',NULL,NULL,NULL,NULL,NULL);
