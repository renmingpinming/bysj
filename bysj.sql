...
insert  into `connect`(`conn_id`,`sid`,`cid`) values (3,20140110,1002),(4,20140111,1002),(10,20140110,1001),(11,20140111,1001);
...
insert  into `course`(`cid`,`cname`,`introduce`,`tno`) values (1001,'语文','这是语文课。',20080101),(1002,'aaa',NULL,NULL),(1003,'数学','这是数学课。',20080101),(1004,'英语','这是英语课。',20080101),(1005,'bbb',NULL,NULL),(1006,'ccc',NULL,NULL),(1007,'eee','',NULL);
...
insert  into `student`(`sid`,`sname`,`password`,`sex`,`classname`,`telephone`,`email`,`clno`) values (20140109,'周6','123','男',NULL,'1','2',1001),(20140110,'周7','123',NULL,NULL,NULL,NULL,1001),(20140111,'周8','123',NULL,NULL,NULL,NULL,NULL),(20140112,'xx','123',NULL,NULL,NULL,NULL,NULL);
...
insert  into `teacher`(`tid`,`tname`,`password`,`sex`,`introduce`,`telephone`,`email`) values (20080101,'bbb','123','女','1234567','17856987598','123'),(20080102,'ccc','123',NULL,NULL,'17826875930',NULL),(20080103,'ddd','123',NULL,NULL,NULL,NULL),(20080104,'eee','123',NULL,NULL,NULL,NULL);
