      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
          	 <s:iterator value="#session.exitTeacher.courses" var="c">
	              ...
	              <p><a class="btn btn-default" href="<%= basePath %>teacherCourseListStudent.action?cid=<s:property value="#c.cid"/>" role="button">显示学生 &raquo;</a></p>
	              <p><a class="btn btn-default" href="<%= basePath %>teacherDeleteCourse.action?cid=<s:property value="#c.cid"/>" role="button">删除课程 &raquo;</a></p>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            <a href="<%= basePath %>teacherListCourse.action?tid=<s:property value="#session.exitTeacher.tid"/>" class="list-group-item active">查看课程</a>
            <a href="<%= basePath %>teacherAddCourseList.action" class="list-group-item">添加课程</a>
          </div>
