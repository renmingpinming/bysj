      ...
      <div class="row row-offcanvas row-offcanvas-right">
            ...
            <table cellspacing="0" border="1" class="table table-striped">
				...
				<tbody>
	  			<s:iterator value="pageBean.list" var="d">  
					<tr>
						<td align="center"><s:property value="#d.tid"/></td>
						<td align="center"><s:property value="#d.tname"/></td>
			...
			<tr>
				...
				<span>
	  		   <s:if test="pageBean.currPage != 1">   
			       <a href="<%= basePath%>departmentTeacherList.action?currPage=1">[首页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentTeacherList.action?currPage=<s:property value="pageBean.currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
			   </s:if>
			   <s:if test="pageBean.currPage != pageBean.totalPage"> 
			       <a href="<%= basePath%>departmentTeacherList.action?currPage=<s:property value="pageBean.currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentTeacherList.action?currPage=<s:property value="pageBean.totalPage"/>">[尾页]</a>&nbsp;&nbsp;
			   </s:if>
			   </span>
				</td>
			</tr>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            <a href="<%= basePath %>departmentTeacherList.action" class="list-group-item active">编辑教师</a>
