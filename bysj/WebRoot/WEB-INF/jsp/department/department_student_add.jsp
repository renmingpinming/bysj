  ...
  <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div>
          	<s:form class="form-signin" action="departmentStudentAdd.action" method="post" theme="simple">
		        <h1>添加学生</h1>
		       <table class="table table-striped">
		       	<tr>
		       		<td>姓名：</td>
		       		<td><s:textfield name="sname" class="form-control"/></td>
		       	</tr>
		       	<tr>
		       		<td>密码：</td>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            <a href="<%= basePath %>departmentStudentList.action" class="list-group-item">管理学生</a>
            <a href="<%= basePath %>departmentStudentAddList.action" class="list-group-item active">添加学生</a>
          </div>
