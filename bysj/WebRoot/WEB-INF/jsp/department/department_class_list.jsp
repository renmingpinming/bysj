      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<%= basePath %>departmentClass.action">班级管理</a></li>
          </ul>
			...
			<tr>
				...
				<span>
	  		   <s:if test="pageBean.currPage != 1">   
			       <a href="<%= basePath%>departmentClassList.action?currPage=1">[首页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentClassList.action?currPage=<s:property value="pageBean.currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
			   </s:if>
			   <s:if test="pageBean.currPage != pageBean.totalPage"> 
			       <a href="<%= basePath%>departmentClassList.action?currPage=<s:property value="pageBean.currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentClassList.action?currPage=<s:property value="pageBean.totalPage"/>">[尾页]</a>&nbsp;&nbsp;
			   </s:if>
			   </span>
				</td>
			</tr>
