			...
			<tr>
				...
				<span>
	  		   <s:if test="pageBean.currPage != 1">   
			       <a href="<%= basePath%>departmentCourseList.action?currPage=1">[首页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentCourseList.action?currPage=<s:property value="pageBean.currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
			   </s:if>
			   <s:if test="pageBean.currPage != pageBean.totalPage"> 
			       <a href="<%= basePath%>departmentCourseList.action?currPage=<s:property value="pageBean.currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
			       <a href="<%= basePath%>departmentCourseList.action?currPage=<s:property value="pageBean.totalPage"/>">[尾页]</a>&nbsp;&nbsp;
			   </s:if>
			   </span>
				</td>
			</tr>
