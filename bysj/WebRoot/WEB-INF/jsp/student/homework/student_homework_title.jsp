          ...
          <h1>所有作业</h1>
	          ...
	          <s:iterator value="list" var="c">
	          	<tr>
	          		...
	          		<td><a class="btn btn-default" href="<%= basePath %>documentUpload.action?hid=<s:property value="#c.hid"/>&course_id=<s:property value="%{#session.course_id}"/>" role="button">详细 &raquo;</a></td>
	          	</tr>
	          </s:iterator>
	          </table>
          </div>
